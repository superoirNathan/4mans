...
public:
    ...
    T speedControlledUpdate(float dt)
    {
        ...
        // the blue value of our point of interest
        ...
        for (unsigned int i = 1; i < m_pSpeedControlLookUpTable.size(); i++)
        {
            ...
            if (m_pSpeedControlLookUpTable[i].arcLengthNormalized >= m_pKeyLocalTime)
            {
                ...
                // use our 2 red values relative to our 2 blue values to get our inbetween red value using our inbetween blue value we solved for
